...
public class TermClassifierTests
{
    ...
    [InlineData("tvdb:0", TermKind.TvdbSearch, "0")]
    [InlineData("tvdb:abc", TermKind.TvdbSearch, "abc")]
    [InlineData("tvdb: breaking bad", TermKind.TvdbSearch, "breaking bad")]
    [InlineData("tmdb:1396", TermKind.TmdbId, "1396")]
    [InlineData("tmdb: 1399", TermKind.TmdbId, "1399")]
    [InlineData("tmdb:0", TermKind.TmdbSearch, "0")]
    [InlineData("tmdb:abc", TermKind.TmdbSearch, "abc")]
    [InlineData("tmdb: breaking bad", TermKind.TmdbSearch, "breaking bad")]
